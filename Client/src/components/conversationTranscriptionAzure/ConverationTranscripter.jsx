    ...
    useEffect(() => {
        const performSummarization = async () => {
            try {
                ...
                NotificationManager.error('Error in text summarization', 5000);
            }
        ...
        NotificationManager.success('Summarization of the transcribed text completed', 'Summarization Completed', 5000);
